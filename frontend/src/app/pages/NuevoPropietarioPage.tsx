...
import {
  ...
  ToggleButtonGroup, ToggleButton, MenuItem, Grid, Snackbar, Alert,
  Breadcrumbs, Link, IconButton, Radio, FormControlLabel,
} from '@mui/material';
...
import {
  createPersonaFisica, createPersonaJuridica, asignarRolPropietario,
  type Telefono, type Mail, type PersonaFisica, type PersonaJuridica, type PropietarioDTO,
  ...
  return (
    <Box>
      <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 2 }}>
        <Link component="button" variant="body1" onClick={() => navigate('/propietarios')}
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
        <Button startIcon={<ArrowBack />} onClick={() => navigate('/propietarios')} variant="outlined">Volver</Button>
        <Typography variant="h4" component="h1">Nuevo Propietario</Typography>
      </Box>
      ...
      <Card sx={{ maxWidth: 800 }}>
        <CardContent sx={{ p: 4 }}>
          <form onSubmit={handleSubmit}>
            <Box sx={{ mb: 4 }}>
              <Typography variant="subtitle1" gutterBottom sx={{ mb: 2, fontWeight: 600 }}>Tipo de Propietario</Typography>
            ...
            {tipo === 'persona' ? (
              <>
                ...
                <TextField fullWidth type="date" value={fechaNacimiento}
                  onChange={(e) => setFechaNacimiento(e.target.value)} sx={{ mb: 3 }} InputLabelProps={{ shrink: true }} />
              </>
            ) : (
              <>
            ...
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
              <Button variant="outlined" onClick={() => navigate('/propietarios')} size="large">Cancelar</Button>
              <Button type="submit" variant="contained" color="primary" size="large">Guardar Propietario</Button>
            </Box>
          </form>
        </CardContent>
      </Card>
